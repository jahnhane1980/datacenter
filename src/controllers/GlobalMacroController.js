...
export class GlobalMacroController extends BaseController {
    /**
     * @param {Object} globalRepo 
     * @param {Object} globalService 
     */
    constructor(globalRepo, globalService, pacingManager = null) {
        super('GlobalMacroController', pacingManager);
        this.globalRepo = globalRepo;
        this.globalService = globalService;
    }

    async runDailySync() {
        await this.executeJob('Global Macro & FX Sync (Daily)', async () => {
            ...
            await this.processItemsSafely(FX_TICKERS, (fx) => fx.pair, async (fx) => {
    ...
    async runBackfill() {
        await this.executeJob('Global Macro & FX Backfill (Historischer Import)', async () => {
