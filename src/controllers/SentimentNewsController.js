...
export class SentimentNewsController extends BaseController {
    /**
    ...
    constructor(tickerRepo, sentimentNewsRepo, sentimentNewsService, pacingManager) {
        super('SentimentNewsController', pacingManager);
     ...
     */
    async runDailySync() {
        await this.executeJob('Daily Sentiment & News Sync', async () => {
     ...
     */
    async runBackfill() {
        await this.executeJob('Sentiment Backfill', async () => {
